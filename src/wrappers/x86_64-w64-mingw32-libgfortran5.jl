# Autogenerated wrapper script for FuzzifiED_jll for x86_64-w64-mingw32-libgfortran5
...
JLLWrappers.@declare_library_product(LibpathSuperFuzzifiED, "libsuperfuzzified.dll")
function __init__()
