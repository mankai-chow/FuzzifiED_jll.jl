...
* git repository: https://github.com/mankai-chow/FuzzifiED_Fortran.git (revision: `32970bd69f9cc2a17e840399fb973a01535078c0`)

## Platforms

`FuzzifiED_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `FuzzifiED_jll.jl`:
...
* `LibraryProduct`: `LibpathFuzzifiED`
* `LibraryProduct`: `LibpathFuzzifino`
